      ...
      <header className="bg-slate-900 text-white shadow-lg no-print">
        <div className="container mx-auto px-4 h-20 flex items-center justify-between">
          <div className="flex items-center space-x-4">
            <div className="w-12 h-12 bg-yellow-500 rounded-xl flex items-center justify-center shadow-lg transform -rotate-3">
            ...
            <div className="flex flex-col">
              <h1 className="text-2xl font-black tracking-tight leading-none text-white">
                Offshore Maintenance Pro 2.0
              </h1>
              <p className="text-[10px] text-slate-500 font-bold uppercase tracking-[0.2em] mt-1">
                Plataformas de Petróleo & Gás
              </p>
            </div>
          </div>
          <nav className="flex items-center space-x-6 text-sm font-medium">
            <div className="hidden md:flex space-x-6 h-full">
              <button 
                ...
                className={`transition-all duration-200 border-b-2 h-20 px-1 flex items-center ${
                  activeTab === 'dashboard' 
            ...
            <button 
              ...
              className="bg-white/10 hover:bg-white/20 p-2.5 rounded-xl transition-all border border-white/20 flex items-center space-x-2 shadow-sm"
